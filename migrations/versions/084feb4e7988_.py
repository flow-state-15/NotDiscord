...
Revision ID: 084feb4e7988
Revises: 
Create Date: 2021-11-08 12:22:48.104306
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['channel_id'], ['servers.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['server_id'], ['channels.id'], ondelete='CASCADE'),
