      ...
      <div className="home-tiles-wrapper">
        <div className="home-tile">
          <div className="home-tile-img-container">
            <img
              src="https://res.cloudinary.com/dan-purcell-2021/image/upload/v1636734889/discord_group_projo_assets/home-tile-img-1_ojbvsc.svg"
              alt="home-tile-img"
            />
          </div>
        ...
        <div className="home-tile">
          ...
          <div className="home-tile-img-container v2">
            <img
              src="https://res.cloudinary.com/dan-purcell-2021/image/upload/v1636737350/discord_group_projo_assets/home-tile-img-2_pwfuon.svg"
              alt="home tile img 2"
            />
          </div>
        </div>
        <div className="home-tile">
          <div className="home-tile-img-container v2">
            <img
              src="https://res.cloudinary.com/dan-purcell-2021/image/upload/v1636737987/discord_group_projo_assets/home-tile-img-3_xvxtxb.svg"
              alt="home tile img 3"
            />
          </div>
          <div className="home-tile-text-container">
        ...
        <div className="home-tile-last">
          <div className="home-tile-last-sparkles">
            <img
              src="https://res.cloudinary.com/dan-purcell-2021/image/upload/v1636738671/discord_group_projo_assets/home-sparkles_xewoyf.svg"
              alt="home-sparkles"
            />
        ...
        <footer>
          ...
          <div className="footer-about-container">
            ...
            <div className="footer-dev-container">
              ...
              <div className="footer-logo-container">
                <a
                  href="https://www.linkedin.com/in/jazon-zhou/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  href="https://github.com/CroissantAhhh"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
